export const state = () => ({
    ...
    fields:[
        ...
        {key:'antrian.no_antrian', label:'No. Antrian', sortable:false},
        {key:'kategori', label:'Kategori', sortable:false},
        {key:'antrian.keperluan.nama', label:'Keperluan', sortable:false},
        {key:'nama', label:'Nama', sortable:false},
        {key:'phone', label:'Phone', sortable:false},
        {key:'alamatpelayanan', label:'Alamat', sortable:false},
        {key:'catatanpelayanan', label:'Catatan', sortable:false},
        {key: 'actions',label:'', sortable: false, thStyle:{width:'15%'}}, 
    ],
    addLink: '',
    btnAction:true,
    edit_data_form: '/pelayanan',
    backBtn:'/pelayanan',
    lists:[],
    list:{},
    meta:{
...
export const actions = {
    async get_data({commit, state}){
        ...
        const res = await this.$repositories.pelayanan.perPage(params)
    ...
    async save({commit, state}, payload){
        ...
        try{
            const res = await this.$repositories.pelayanan.save(state.nmodel)
    ...
    async show({commit,state}, id){
        ...
        const res = await this.$repositories.pelayanan.show(id)
    ...
    async update({commit, state}, payload){
        ...
        try{
            const res = await this.$repositories.pelayanan.update(state.nmodel.kode, state.nmodel)
